...
class ItemfundscateController extends BaseController
{
    /* ++++++++++ 初始化 ++++++++++ */
    ...
    public function index(Request $request){
        ...
        DB::beginTransaction();
        try{
            $itemfundscates=$model->where($where)->select($select)->orderBy($ordername,$orderby)->sharedLock()->paginate($displaynum);
            if(blank($itemfundscates)){
        ...
        DB::commit();
        $infos['itemfundscates']=$itemfundscates;
        $infos[$code]=$msg;
    ...
    public function add(Request $request){
        ...
        /* ********** 视图 ********** */
            ...
            /* ++++++++++ 输出视图 ++++++++++ */
            return view('system.itemfundscate.add');
        }
    }
    ...
    public function info(Request $request){
        ...
        /* ********** 当前数据 ********** */
        DB::beginTransaction();
        $itemfundscate=Itemfundscate::withTrashed()
            ->sharedLock()
            ->find($id);
        ...
        /* ********** 输出视图 ********** */
        return view('system.itemfundscate.info',$infos);
    }
    ...
    public function edit(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            /* ********** 输出视图 ********** */
            return view('system.itemfundscate.edit',$infos);
        }
