                ...
                if(ajaxResp.code=='error'){
                    ...
                    if(ajaxResp.sdata.length){
                        ...
                        $.each(ajaxResp.sdata,function (index,info) {
                            ...
                            childs +='<td><div class="btn-group"><a href="{{route('g_dept_add')}}?id='+info.id+'" class="btn btn-sm">添加下级</a><a href="{{route('g_dept_info')}}?id='+info.id+'" class="btn btn-sm">查看详情</a></div></td>';
                            childs +='</tr>';
                        });
