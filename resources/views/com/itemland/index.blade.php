...
@section('content')
    <div class="well well-sm">
        <a href="{{route('c_itemland_add',['item'=>$edata['item_id']])}}" class="btn">添加项目地块</a>
    </div>
    <div class="row">
        <div class="col-xs-12">
            @if($code=='success')
                    ...
                    <div class="col-xs-6 col-sm-3 pricing-box">
                        <div class="widget-box widget-color-dark">
                            ...
                            <div class="widget-body">
                                ...
                                <div>
                                    <a href="{{route('c_itemland_info',['id'=>$infos->id,'item'=>$infos->item_id])}}" class="btn btn-block btn-inverse">
                                        <span>进入地块</span>
