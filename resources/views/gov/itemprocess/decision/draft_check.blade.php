...
@section('content')
    ...
    <div class="widget-box widget-color-red">
        <div class="widget-header">
            <h4 class="widget-title lighter smaller">征收意见稿审查意见</h4>
        </div>

        <div class="widget-body">
            <div class="widget-main padding-8">
                <form class="form-horizontal" role="form" action="{{route('g_draft_check',['item'=>$sdata['item']->id])}}" method="post">
                    {{csrf_field()}}
    ...
    <div class="widget-box widget-color-blue2">
        <div class="widget-header">
            <h4 class="widget-title lighter smaller">征收意见稿：</h4>
            <div class="widget-toolbar">
                <a href="#" data-action="collapse">
            ...
            <div class="widget-main padding-8">
                ...
                <div class="profile-user-info profile-user-info-striped">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <textarea id="content" name="content" style="width:100%;min-height: 360px;">{{$sdata['itemdraft']->content}}</textarea>
                        </div>
                    </div>
