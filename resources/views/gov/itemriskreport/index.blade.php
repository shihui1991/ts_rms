...
@section('content')
    <div class="well well-sm">
        @if (blank($sdata))
            <a href="{{route('g_itemriskreport_add',['item'=>$edata['item_id']])}}" class="btn">添加社会稳定风险评估报告</a>
        @else
            <a href="{{route('g_itemriskreport_edit',['id'=>$sdata->id,'item'=>$sdata->item_id])}}" class="btn">修改社会稳定风险评估报告</a>
        @endif
            <a href="{{route('g_itemrisk',['item'=>$edata['item_id']])}}" class="btn">社会稳定性风险评估</a>
    </div>
    @if (filled($sdata))
                        ...
                        <div class="user-profile row">
                            <div class="col-xs-12 col-sm-9">
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> 结论： </div>
                                        <div class="profile-info-value">
