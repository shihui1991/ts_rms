...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_landlayout_edit',['item'=>$sdata['item']->id])}}" method="post">
        {{csrf_field()}}
                ...
                <div class="form-group img-box">
                    <label class="col-sm-3 control-label no-padding-right">
                        ...
                        <span class="btn btn-xs">
                            <span>上传图片</span>
                            <input type="file" accept="image/*" class="hidden" data-name="gov_img[]" multiple  onchange="uplfile(this)">
                         </span>
                    </label>
                    <div class="col-sm-9">
                                ...
                                @foreach($sdata['landlayout']->gov_img as $pic)
                                    <li>
                                        <div>
                                            ...
                                            <input type="hidden" name="gov_img[]" value="{!! $pic !!}">
                                            <div class="text">
                                                <div class="inner">
