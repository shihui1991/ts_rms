...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_houseprice_edit')}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="price" name="price" value="{{$sdata->price}}" class="col-xs-10 col-sm-5" required>
            </div>
        </div>
        <div class="space-4"></div>
