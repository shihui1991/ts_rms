...
@section('content')
    ...
    <p>
        ...
        <a class="btn" href="{{route('g_crowd_edit',['id'=>$sdata->id])}}">
    ...
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            <div class="profile-info-name"> 特殊人群分类： </div>
            <div class="profile-info-value">
                <span class="editable editable-click">{{$sdata->father->name}}{{$sdata->father->id?:'【当前为分类】'}}</span>
            </div>
        </div>
