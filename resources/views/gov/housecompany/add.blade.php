...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_housecompany_add')}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="phone" name="phone" value="{{old('phone')}}" class="col-xs-10 col-sm-5"  placeholder="请输入电话">
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="contact_man" name="contact_man" value="{{old('contact_man')}}" class="col-xs-10 col-sm-5"  placeholder="请输入联系人">
            </div>
        </div>
        <div class="space-4"></div>

        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="contact_tel"> 联系电话： </label>
            <div class="col-sm-9">
                <input type="text" id="contact_tel" name="contact_tel" value="{{old('contact_tel')}}" class="col-xs-10 col-sm-5"  placeholder="请输入联系电话">
            </div>
        </div>
        <div class="space-4"></div>
