...
@section('content')
    ...
    <p>
        ...
        <a class="btn" href="{{route('g_itemhouserate_edit',['id'=>$sdata->id,'item'=>$sdata->item_id])}}">
    ...
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            <div class="profile-info-name"> 起始面积（超出）： </div>
            <div class="profile-info-value">
                <span class="editable editable-click">{{$sdata->start_area}} ㎡</span>
            </div>
        </div>

        <div class="profile-info-row">
            <div class="profile-info-name"> 截止面积（超出）： </div>
            <div class="profile-info-value">
                <span class="editable editable-click">{{$sdata->end_area}} ㎡</span>
            </div>
        </div>
