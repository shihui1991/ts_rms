...
) ENGINE=MyISAM AUTO_INCREMENT=343 DEFAULT CHARSET=utf8 COMMENT='功能与菜单';
...
CREATE TABLE `a_subject` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`) COMMENT '名称唯一'
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='重要补偿科目';
...
INSERT INTO `a_subject` VALUES ('18', '超期临时安置费', '0', null, '2018-03-10 17:45:50', '2018-03-10 17:45:50', null);
INSERT INTO `a_subject` VALUES ('19', '超期临时安置费特殊人群优惠补助', '0', null, '2018-03-10 17:46:13', '2018-03-10 17:46:24', null);
...
-- ----------------------------
INSERT INTO `item_draft_report` VALUES ('10', '1', '2', '标题测试', '<p><strong>test</strong></p><p><strong>45656</strong></p><p><strong><img src=\"/ueditor/php/upload/image/20180301/1519872915204711.png\" title=\"1519872915204711.png\" alt=\"棋牌.png\"/></strong></p>', 'test code1', '2018-02-28 19:19:03', '2018-03-01 10:55:17', null);
...
CREATE TABLE `item_household_assets` (
  ...
  KEY `land_id` (`land_id`),
  KEY `building_id` (`building_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目-被征收户-资产';
...
CREATE TABLE `item_land_layout` (
  ...
  KEY `item_id` (`item_id`),
  KEY `land_id` (`land_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目-地块户型';
...
CREATE TABLE `item_program` (
  ...
  `reward_house` decimal(10,2) DEFAULT '0.00' COMMENT '签约奖励单价-住宅-货币补偿',
  `reward_other` decimal(10,2) DEFAULT '0.00' COMMENT '签约奖励比例（%）-非住宅-货币补偿',
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='项目-征收方案';

-- ----------------------------
-- Records of item_program
-- ----------------------------
INSERT INTO `item_program` VALUES ('4', '1', '测试', '<p>test</p>', '20', null, '20.00', '80.00', '20.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1', '1', '1.00', '1.00', '1.00', '1.00', '2018-03-10 18:27:24', '2018-03-10 18:41:26', null);
...
-- ----------------------------
INSERT INTO `item_public` VALUES ('1', '1', '1', '1', '砖', '块', '120', null, null, null, '[\"\\/storage\\/180310\\/vBTcY0u9bkNb5VeWHV52ch88I3uNT7QcvGdCvyjW.jpeg\"]', null, '2018-03-10 17:12:20', '2018-03-10 17:12:20', null);
INSERT INTO `item_public` VALUES ('2', '1', '1', '0', '围墙', '面', '4', null, null, null, '[\"\\/storage\\/180310\\/eH0urX1pn4e01Qf9YcuuyBayT2gwiI9JX2W1TIXS.jpeg\"]', null, '2018-03-10 17:12:58', '2018-03-10 17:12:58', null);
...
CREATE TABLE `item_reward` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='项目-签约奖励（产权调换）';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='项目-补偿科目说明（非固定项）';
...
INSERT INTO `item_work_notice` VALUES ('7', '1', '1', '3', '218', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '20', null, null, null, '2018-02-24 11:41:17', '2018-02-26 09:36:16', '2018-02-26 09:36:16');
INSERT INTO `item_work_notice` VALUES ('8', '1', '1', '3', '218', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '20', null, null, null, '2018-02-24 11:52:55', '2018-02-24 16:42:22', '2018-02-24 16:42:22');
INSERT INTO `item_work_notice` VALUES ('9', '1', '1', '3', '218', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '23', null, '驳回', null, '2018-02-24 11:52:55', '2018-02-26 09:36:16', null);
INSERT INTO `item_work_notice` VALUES ('10', '1', '1', '3', '218', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '20', null, null, null, '2018-02-24 11:52:55', '2018-02-26 09:36:16', '2018-02-26 09:36:16');
INSERT INTO `item_work_notice` VALUES ('11', '1', '1', '5', '222', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_roll_back?item=1', '0', null, null, null, '2018-02-26 09:36:16', '2018-02-26 10:21:37', '2018-02-26 10:21:37');
INSERT INTO `item_work_notice` VALUES ('12', '1', '1', '5', '222', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_roll_back?item=1', '2', null, null, null, '2018-02-26 09:36:16', '2018-02-26 10:58:59', null);
INSERT INTO `item_work_notice` VALUES ('13', '1', '1', '5', '222', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_roll_back?item=1', '0', null, null, null, '2018-02-26 09:36:16', '2018-02-26 10:21:37', '2018-02-26 10:21:37');
INSERT INTO `item_work_notice` VALUES ('14', '1', '1', '4', '223', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_iteminfo_retry?item=1', '0', null, null, null, '2018-02-26 10:58:59', '2018-02-26 14:38:10', '2018-02-26 14:38:10');
INSERT INTO `item_work_notice` VALUES ('15', '1', '1', '4', '223', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_iteminfo_retry?item=1', '2', null, null, null, '2018-02-26 10:58:59', '2018-02-26 14:38:10', null);
INSERT INTO `item_work_notice` VALUES ('16', '1', '1', '4', '223', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_iteminfo_retry?item=1', '0', null, null, null, '2018-02-26 10:58:59', '2018-02-26 14:38:10', '2018-02-26 14:38:10');
...
INSERT INTO `item_work_notice` VALUES ('20', '1', '1', '3', '218', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '20', null, null, null, '2018-02-26 14:38:59', '2018-02-26 14:42:18', '2018-02-26 14:42:18');
INSERT INTO `item_work_notice` VALUES ('21', '1', '1', '3', '218', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '22', null, '通过', null, '2018-02-26 14:38:59', '2018-02-26 15:40:11', null);
INSERT INTO `item_work_notice` VALUES ('22', '1', '1', '3', '218', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_dept_check?item=1', '20', null, null, null, '2018-02-26 14:38:59', '2018-02-26 14:42:18', '2018-02-26 14:42:18');
INSERT INTO `item_work_notice` VALUES ('23', '1', '1', '5', '222', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_roll_back?item=1', '0', null, null, null, '2018-02-26 14:42:18', '2018-02-26 14:43:42', '2018-02-26 14:43:42');
INSERT INTO `item_work_notice` VALUES ('24', '1', '1', '5', '222', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_roll_back?item=1', '2', null, null, null, '2018-02-26 14:42:18', '2018-02-26 14:43:42', null);
INSERT INTO `item_work_notice` VALUES ('25', '1', '1', '5', '222', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_roll_back?item=1', '0', null, null, null, '2018-02-26 14:42:18', '2018-02-26 14:43:42', '2018-02-26 14:43:42');
INSERT INTO `item_work_notice` VALUES ('26', '1', '1', '15', '225', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_item_stop?item=1', '0', null, null, null, '2018-02-26 14:43:42', '2018-02-26 15:05:02', '2018-02-26 15:05:02');
INSERT INTO `item_work_notice` VALUES ('27', '1', '1', '15', '225', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_item_stop?item=1', '2', null, null, null, '2018-02-26 14:43:42', '2018-02-26 15:05:02', null);
INSERT INTO `item_work_notice` VALUES ('28', '1', '1', '15', '225', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_item_stop?item=1', '0', null, null, null, '2018-02-26 14:43:42', '2018-02-26 15:05:02', '2018-02-26 15:05:02');
...
INSERT INTO `item_work_notice` VALUES ('32', '1', '1', '7', '230', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_gov_check?item=1', '20', null, null, null, '2018-02-26 16:09:31', '2018-02-26 17:56:22', '2018-02-26 17:56:22');
INSERT INTO `item_work_notice` VALUES ('33', '1', '1', '7', '230', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_gov_check?item=1', '22', null, '通过', null, '2018-02-26 16:09:31', '2018-02-26 17:56:22', null);
INSERT INTO `item_work_notice` VALUES ('34', '1', '1', '7', '230', '1', '2', '3', '4', 'http://ts.rms.cn:8008/gov/check_gov_check?item=1', '20', null, null, null, '2018-02-26 16:09:31', '2018-02-26 17:56:22', '2018-02-26 17:56:22');
INSERT INTO `item_work_notice` VALUES ('35', '1', '1', '8', '231', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_start_set?item=1', '0', null, null, null, '2018-02-26 17:56:22', '2018-02-28 10:04:17', '2018-02-28 10:04:17');
INSERT INTO `item_work_notice` VALUES ('36', '1', '1', '8', '231', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_start_set?item=1', '0', null, null, null, '2018-02-26 17:56:22', '2018-02-28 10:04:17', '2018-02-28 10:04:17');
INSERT INTO `item_work_notice` VALUES ('37', '1', '1', '8', '231', '1', '0', '1', '4', 'http://ts.rms.cn:8008/gov/check_start_set?item=1', '1', null, null, null, '2018-02-26 17:56:22', '2018-02-28 10:52:39', null);
...
INSERT INTO `item_work_notice` VALUES ('56', '1', '1', '11', '248', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_set_to_check?item=1', '0', null, null, null, '2018-02-28 11:25:45', '2018-02-28 14:58:47', '2018-02-28 14:58:47');
INSERT INTO `item_work_notice` VALUES ('57', '1', '1', '11', '248', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_set_to_check?item=1', '0', null, null, null, '2018-02-28 11:25:45', '2018-02-28 14:58:47', '2018-02-28 14:58:47');
INSERT INTO `item_work_notice` VALUES ('58', '1', '1', '11', '248', '1', '0', '1', '4', 'http://ts.rms.cn:8008/gov/check_set_to_check?item=1', '2', null, null, null, '2018-02-28 11:25:45', '2018-02-28 14:58:47', null);
INSERT INTO `item_work_notice` VALUES ('59', '1', '1', '12', '249', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_set_check?item=1', '20', null, null, null, '2018-02-28 14:58:47', '2018-02-28 17:07:14', '2018-02-28 17:07:14');
INSERT INTO `item_work_notice` VALUES ('60', '1', '1', '12', '249', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_set_check?item=1', '20', null, null, null, '2018-02-28 14:58:47', '2018-02-28 17:07:14', '2018-02-28 17:07:14');
INSERT INTO `item_work_notice` VALUES ('61', '1', '1', '12', '249', '1', '0', '1', '4', 'http://ts.rms.cn:8008/gov/check_set_check?item=1', '22', null, '审查通过', null, '2018-02-28 14:58:47', '2018-02-28 17:32:03', null);
INSERT INTO `item_work_notice` VALUES ('74', '1', '1', '13', '252', '0', '0', '1', '1', 'http://ts.rms.cn:8008/gov/check_item_start?item=1', '0', null, null, null, '2018-02-28 17:32:03', '2018-02-28 17:32:03', null);
INSERT INTO `item_work_notice` VALUES ('75', '1', '1', '13', '252', '1', '0', '1', '3', 'http://ts.rms.cn:8008/gov/check_item_start?item=1', '0', null, null, null, '2018-02-28 17:32:03', '2018-02-28 17:32:03', null);
INSERT INTO `item_work_notice` VALUES ('76', '1', '1', '13', '252', '1', '0', '1', '4', 'http://ts.rms.cn:8008/gov/check_item_start?item=1', '0', null, null, null, '2018-02-28 17:32:03', '2018-02-28 17:32:03', null);
