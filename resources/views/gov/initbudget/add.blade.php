...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_initbudget_add',['item'=>$sdata['item']->id])}}" method="post">
        {{csrf_field()}}
                    ...
                    <div class="widget-body">
                        <div class="widget-main padding-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0" id="holder" name="budget[holder]" value="" class="col-xs-10 col-sm-10" required>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0" id="money" name="budget[money]" value="" class="col-xs-10 col-sm-10" required>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0" id="house" name="budget[house]" value="" class="col-xs-10 col-sm-10" required>
                                </div>
                            </div>
                            <div class="space-4"></div>
