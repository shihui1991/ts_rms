...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_news_other_add',['item'=>$sdata['item']->id])}}" method="post">
        {{csrf_field()}}
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="cate" value="其他公告" class="col-xs-10 col-sm-10"  readonly>
                                    </div>
                                </div>
                                <div class="space-4"></div>
