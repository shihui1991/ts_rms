...
Route::namespace('gov')->prefix('gov')->group(function (){
    ...
    Route::any('dept_select_parent','DeptController@select_parent')->name('gov_dept_select_parent');
    ...
    Route::any('user_select_parent','UserController@select_parent')->name('gov_user_select_parent');
