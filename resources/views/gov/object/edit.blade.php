...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_object_edit')}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="num_unit" name="num_unit" value="{{$sdata->num_unit}}" class="col-xs-10 col-sm-5" required>
            </div>
        </div>
        <div class="space-4"></div>
