                ...
                <div class="tab-content">
                    <div id="base_info" class="tab-pane fade active in">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="item_end" name="item_end" value="{{$sdata->item_end}}" class="col-xs-10 col-sm-5 laydate" data-type="date" data-format="yyyy-MM-dd"  required>
                                </div>
                            </div>
                            <div class="space-4"></div>
                    ...
                    <div id="content_info" class="tab-pane fade">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea  style="width: 100%" id="content" name="content"  placeholder="请输入内容" >{{$sdata->content}}</textarea>
                            </div>
                        </div>
                        <div class="space-4"></div>
                    </div>
