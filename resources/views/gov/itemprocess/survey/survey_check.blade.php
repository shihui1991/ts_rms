...
@section('content')
    ...
    <p>
        <a href="{{route('g_survey',['item'=>$sdata['item']->id])}}" class="btn btn-info">查看调查数据</a>
    </p>
    <div class="widget-box widget-color-red">
        ...
        <div class="widget-body">
            <div class="widget-main padding-8">
                <form class="form-horizontal" role="form" action="{{route('g_survey_check',['item'=>$sdata['item']->id])}}" method="post">
                    {{csrf_field()}}
