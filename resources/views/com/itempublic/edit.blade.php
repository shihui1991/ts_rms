...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('c_itempublic_edit',['item'=>$sdata['item']->id])}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="number" id="com_num" name="com_num" value="{{$sdata['itempublic']->com_num}}" class="col-xs-10 col-sm-5"  placeholder="请输入数量" required>
            </div>
        </div>
        <div class="space-4"></div>
