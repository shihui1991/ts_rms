...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_housecompany_edit')}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="phone" name="phone" value="{{$sdata->phone}}" class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="contact_man" name="contact_man" value="{{$sdata->contact_man}}" class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="contact_tel" name="contact_tel" value="{{$sdata->contact_tel}}" class="col-xs-10 col-sm-5">
            </div>
        </div>
        <div class="space-4"></div>
