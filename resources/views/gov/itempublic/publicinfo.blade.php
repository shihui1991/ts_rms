...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('g_publicinfo')}}" method="post">
        {{csrf_field()}}
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="name"> 类型： </label>
            <div class="col-sm-9">
                <input type="text" id="name"  value="@if($sdata->building_id>0)楼栋附属物@else 地块附属物@endif" class="col-xs-10 col-sm-5" disabled>
            </div>
        </div>
        <div class="space-4"></div>
        @if($sdata->building_id>0)
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="name"> 楼栋号： </label>
                <div class="col-sm-9">
                    <input type="text" id="name"  value="{{$sdata->itembuilding->building}}" class="col-xs-10 col-sm-5" disabled>
                </div>
            </div>
            <div class="space-4"></div>
        @endif
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea id="infos"  class="col-xs-10 col-sm-5" disabled>{{$sdata->infos}}</textarea>
            </div>
        </div>
        <div class="space-4"></div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="number" id="number" value="{{$sdata->number}}" name="number" class="col-xs-10 col-sm-5"  placeholder="请输入数量">
            </div>
        </div>
        <div class="space-4"></div>
