...
@section('content')
    ...
    <div class="widget-box widget-color-red">
        <div class="widget-header">
            <h4 class="widget-title lighter smaller">社会稳定风险评估报告审查意见</h4>
        </div>

        <div class="widget-body">
            <div class="widget-main padding-8">
                <form class="form-horizontal" role="form" action="{{route('g_riskreport_check',['item'=>$sdata['item']->id])}}" method="post">
                    {{csrf_field()}}
    ...
    <div class="widget-box widget-color-blue2">
        <div class="widget-header">
            <h4 class="widget-title lighter smaller">社会稳定风险评估报告：</h4>
            <div class="widget-toolbar">
                <a href="#" data-action="collapse">
                ...
                <div class="profile-user-info profile-user-info-striped">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <span class="editable editable-click">{{$sdata['risk_report']->name}}</span>
                        </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <span class="editable editable-click">{{$sdata['risk_report']->agree}}</span>
                        </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <textarea id="content" name="content" style="width:100%;min-height: 360px;">{{$sdata['risk_report']->content}}</textarea>
                        </div>
                    </div>
