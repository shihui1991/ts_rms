...
@section('content')
    ...
    <form class="form-horizontal" role="form" action="{{route('c_companyvaluer_add')}}" method="post">
        {{csrf_field()}}
        <input type="hidden" name="company_id" id="company_id" value="{{session('com_user.company_id')}}" >
